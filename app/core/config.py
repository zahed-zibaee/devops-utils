...
class Settings(BaseSettings):
    ...
    DB_POSTGRES_WRITE_DATABASE_APP_SETTINGS: str = 'app-settings'
    DB_POSTGRES_WRITE_DATABASE_LEGACY: str = 'legacy'
    DB_POSTGRES_WRITE_DATABASE_ORDER: str = 'order'
    DB_POSTGRES_WRITE_DATABASE_ORDER_DISPATCH: str = 'order-dispatch'
    DB_POSTGRES_WRITE_DATABASE_OTP: str = 'otp'
    DB_POSTGRES_WRITE_DATABASE_PAYMENT: str = 'payment'
    DB_POSTGRES_WRITE_DATABASE_PRICING: str = 'pricing'
    DB_POSTGRES_WRITE_DATABASE_PRODUCT: str = 'product'
    DB_POSTGRES_WRITE_DATABASE_SELLER: str = 'seller'
    DB_POSTGRES_WRITE_DATABASE_SUPPLY_WALLET: str = 'supply-wallet'
    DB_POSTGRES_WRITE_DATABASE_USER: str = 'user'
    DB_POSTGRES_WRITE_DATABASE_VOUCHER: str = 'voucher'
    DB_POSTGRES_WRITE_DATABASE_WALLET: str = 'wallet'
    ...
    DB_POSTGRES_READ_DATABASE_APP_SETTINGS: str = 'app-settings'
    DB_POSTGRES_READ_DATABASE_LEGACY: str = 'legacy'
    DB_POSTGRES_READ_DATABASE_ORDER: str = 'order'
    DB_POSTGRES_READ_DATABASE_ORDER_DISPATCH: str = 'order-dispatch'
    DB_POSTGRES_READ_DATABASE_OTP: str = 'otp'
    DB_POSTGRES_READ_DATABASE_PAYMENT: str = 'payment'
    DB_POSTGRES_READ_DATABASE_PRICING: str = 'pricing'
    DB_POSTGRES_READ_DATABASE_PRODUCT: str = 'product'
    DB_POSTGRES_READ_DATABASE_SELLER: str = 'seller'
    DB_POSTGRES_READ_DATABASE_SUPPLY_WALLET: str = 'supply-wallet'
    DB_POSTGRES_READ_DATABASE_USER: str = 'user'
    DB_POSTGRES_READ_DATABASE_VOUCHER: str = 'voucher'
    DB_POSTGRES_READ_DATABASE_WALLET: str = 'wallet'
    DB_POSTGRES_READ_DATABASE_PRODUCT: str = 'product'
    ...
    DB_POSTGRES_AGGREGATION_READ_HOST: str = '127.0.0.1'
    DB_POSTGRES_AGGREGATION_READ_DATABASE: str = 'aaggregation'
    DB_POSTGRES_AGGREGATION_READ_USERNAME: str = 'aaggregation'
    DB_POSTGRES_AGGREGATION_READ_PORT: str = '5432'
    DB_POSTGRES_AGGREGATION_READ_PASSWORD: str = 'mypass'
    # PostgreSQL Aggregation config
    DB_POSTGRES_AGGREGATION_WRITE_HOST: str = '127.0.0.1'
    DB_POSTGRES_AGGREGATION_WRITE_DATABASE: str = 'aaggregation'
    DB_POSTGRES_AGGREGATION_WRITE_USERNAME: str = 'aaggregation'
    DB_POSTGRES_AGGREGATION_WRITE_PORT: str = '5432'
    DB_POSTGRES_AGGREGATION_WRITE_PASSWORD: str = 'mypass'
    # Toggle Feature
