...
RUN pip install --trusted-host files.pythonhosted.org --upgrade --no-cache-dir pip &&  pip install --trusted-host files.pythonhosted.org --no-cache-dir --upgrade -r requirements.txt
